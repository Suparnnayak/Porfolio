    ...
    return (
        <div className="min-h-screen bg-cream pb-24">
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 mt-8 md:mt-16 mb-8 md:mb-12">
                ...
                >
                    <div className="font-mono text-xs font-bold uppercase tracking-[0.3em] text-ink/40 mb-3">Resume</div>
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 mb-12">
                <div className="flex flex-wrap gap-3 mb-5">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="neo-card bg-ink text-cream px-5 py-3 font-heading font-bold text-sm uppercase tracking-wider flex items-center gap-2 hover:bg-acid hover:text-ink transition-colors"
                    >
                        <FileText size={16} />
                        Open PDF
                    </a>
                    <a
                        ...
                        className="neo-card bg-acid text-ink px-5 py-3 font-heading font-bold text-sm uppercase tracking-wider flex items-center gap-2 hover:bg-ink hover:text-cream transition-colors"
                    >
                        <Download size={16} />
                        Download
                    </a>
                ...
                <div className="mt-4 font-mono text-xs font-bold text-ink/50 flex items-center gap-2 uppercase tracking-wider">
