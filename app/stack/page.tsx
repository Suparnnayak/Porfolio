...
const categories = [
    {
        ...
        textColor: "text-ink",
        tools: [
            { name: "C / C++", level: 88, detail: "Core language base for systems projects, DSA, and performance-focused logic." },
            { name: "Python", level: 90, detail: "Used across ML workflows, backend scripting, and rapid prototyping." },
            { name: "Java", level: 74, detail: "Comfortable with OOP fundamentals and implementation-focused coursework." },
            { name: "JavaScript", level: 78, detail: "Used for web interfaces, client interactions, and API integrations." },
            { name: "TypeScript", level: 75, detail: "Used in Next.js projects for typed frontend and full project safety." },
        ],
    },
    {
        name: "Core CS",
        ...
        tools: [
            { name: "Data Structures & Algorithms", level: 90, detail: "Priority queues, heaps, graphs, hashing, and algorithmic optimization." },
            { name: "Object-Oriented Design", level: 82, detail: "Class modeling, abstraction, and extensible software structure." },
            { name: "Operating Systems", level: 76, detail: "Concurrency concepts, process behavior, synchronization, and systems basics." },
            { name: "DBMS", level: 80, detail: "Relational design, transactions, indexing, and query-performance fundamentals." },
        ],
    },
    {
        ...
        textColor: "text-cream",
        tools: [
            { name: "Distributed Systems", level: 80, detail: "Experience with consistency models and multi-node coordination concepts." },
            { name: "Node.js", level: 80, detail: "Used for backend services, realtime layers, and system-facing APIs." },
            { name: "Express", level: 78, detail: "REST API development and middleware-based request handling." },
            { name: "POSIX Threads", level: 74, detail: "Applied thread-level concurrency concepts in systems-oriented implementations." },
            { name: "WebSockets", level: 82, detail: "Built low-latency real-time synchronization and bidirectional communication." },
            { name: "REST APIs", level: 84, detail: "Designed and integrated HTTP APIs for application interoperability." },
        ],
    },
    {
        name: "Databases",
        ...
        textColor: "text-cream",
        tools: [
            { name: "SQL (Design + Indexing)", level: 86, detail: "Relational schema design, indexing strategy, and query optimization basics." },
            { name: "MySQL", level: 78, detail: "Used for application persistence and relational query workflows." },
            { name: "MongoDB", level: 74, detail: "Used in document-oriented use cases and project-level data persistence." },
            { name: "Custom LSM-Trees", level: 82, detail: "Built an embedded LSM-style KV engine with WAL, SSTables, and compaction." },
        ],
    },
    {
        ...
        textColor: "text-cream",
        tools: [
            { name: "Git", level: 86, detail: "Version-control workflow for feature development and clean project history." },
            { name: "GitHub", level: 86, detail: "Repository management, collaboration, and public project showcasing." },
            { name: "Docker", level: 74, detail: "Containerized local/dev workflows and reproducible runtime setup." },
            { name: "WebAssembly (WASM)", level: 80, detail: "Compiled C++ core modules to browser-executable WASM for speed." },
            { name: "Render", level: 72, detail: "Used for backend/service hosting in project deployments." },
            { name: "Vercel", level: 80, detail: "Deployment path for frontend and full Next.js-based applications." },
        ],
    },
];
