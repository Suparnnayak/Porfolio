    ...
    return (
        <div className="min-h-screen bg-cream pb-28 md:pb-24">
            ...
            <div className="w-full bg-ink border-b-[3px] border-ink py-2 px-2 sm:px-4 md:px-8 flex justify-between items-center">
                ...
                <span className="font-mono text-xs font-bold text-cream/60 tracking-widest">{projects.length} DEPLOYED</span>
            </div>
                ...
                <div className="neo-card bg-ink text-cream p-6 md:p-10 relative overflow-hidden gradient-top-accent">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div className="w-full md:w-auto">
                            ...
                            <p className="font-mono text-sm font-bold text-cream/72 max-w-md">
                                More repositories, experiments, and coursework projects are available on my GitHub profile.
                            </p>
                        </div>
                        <a
