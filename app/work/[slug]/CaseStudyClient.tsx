                ...
                <div className="grid md:grid-cols-2 gap-5">
                    ...
                    >
                        <div className="neo-card bg-ink text-cream p-6 md:p-8 h-full relative overflow-hidden gradient-top-accent">
                            ...
                            <div className="relative z-10">
                                <div className="font-mono text-xs font-bold uppercase tracking-[0.3em] text-cream/55 mb-3">The Solution</div>
                                ...
                                <p className="font-mono text-sm font-bold text-cream/78 leading-relaxed">
                                    {project.solution}
                                </p>
                            </div>
                        </div>
                ...
                <div className="neo-card bg-ink text-cream p-6 md:p-10 relative overflow-hidden gradient-top-accent">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        <div className="w-full md:w-auto">
                            ...
                            <p className="font-mono text-xs font-bold text-cream/72">
