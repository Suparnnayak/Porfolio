...
export const projects: Project[] = [
    ...
    },
    {
        ...
        slug: "cotype",
        title: "CoType",
        description: "A distributed collaborative editor with Sequence CRDT sync, WebSocket-based real-time edits, and WASM-accelerated core logic.",
        longDescription: "CoType is a real-time collaborative editor where conflict resolution is handled through a custom Sequence CRDT (LSEQ-style fractional indexing) implemented in C++ and compiled to WebAssembly for near-native client-side performance.",
        tech: ["C++", "WebAssembly", "React", "Node.js", "Socket.io", "MongoDB", "CRDT"],
        metrics: [
        ...
        color: "bg-electric",
        textColor: "text-cream",
        link: "https://github.com/Suparnnayak/CRDT-editor",
        category: "Distributed Systems",
        problem: "Collaborative editors face concurrent edit conflicts, high sync latency, and dependency on centralized conflict resolution, which can degrade user experience under active multi-user sessions.",
        solution: "I designed a WebSocket-driven synchronization layer and implemented a custom Sequence CRDT with fractional indexing and deterministic ordering in C++, then compiled core logic to WASM so conflict resolution runs efficiently inside the browser.",
        outcomes: [
    ...
    },
    {
        ...
        slug: "aetherweb",
        title: "AetherWeb",
        description: "A high-concurrency thread-pool HTTP server built from scratch with low-level socket programming and multiplexed I/O.",
        longDescription: "AetherWeb is a systems-focused web server project that evolves into a scalable thread-pool + I/O multiplexing architecture, emphasizing throughput, latency, and safe concurrent request handling.",
        tech: ["C++11", "Winsock", "Thread Pool", "Socket Programming", "I/O Multiplexing", "Mutex", "Condition Variable"],
        metrics: [
            { label: "Clients", value: "10k+" },
            { label: "Workers", value: "Thread Pool" },
            { label: "I/O", value: "Non-blocking" },
        ],
        color: "bg-vivid",
        textColor: "text-cream",
        link: "https://github.com/Suparnnayak/AetherWeb",
        category: "Systems / Networking",
        problem: "Traditional blocking server models and unbounded thread-per-connection approaches struggle under burst traffic, leading to CPU pressure, race-prone request handling, and poor peak scalability.",
        solution: "I built a custom thread-pool server using low-level sockets with non-blocking intake and multiplexed connection handling, then synchronized worker execution with mutex/condition-variable based queues to keep processing thread-safe and stable.",
        outcomes: [
    ...
    },
    {
        ...
        slug: "aegisdb",
        title: "AegisDB",
        description: "An embedded LSM-tree key-value engine with WAL durability, MemTable/SSTable architecture, compaction, and Bloom-filter optimized reads.",
        longDescription: "AegisDB is a fault-tolerant embedded database prototype built around LSM-tree principles, combining write-optimized ingestion with durable recovery and read-latency optimizations.",
        tech: ["C++11", "LSM Tree", "WAL", "MemTable", "SSTable", "Bloom Filter", "Compaction"],
        metrics: [
            { label: "Read Latency", value: "-40%" },
            { label: "Durability", value: "WAL" },
            { label: "Engine", value: "Embedded" },
        ],
        color: "bg-hotpink",
        textColor: "text-cream",
        link: "https://github.com/Suparnnayak/AegisDB",
        category: "Database Systems",
        problem: "Continuous high-volume writes and mixed read workloads require a design that keeps writes durable and fast while avoiding unnecessary disk seeks during lookups.",
        solution: "I implemented an LSM-style engine with WAL-first durability, in-memory MemTables, immutable SSTables, and Bloom-filter based file skipping to minimize redundant disk access, plus compaction for stale-version cleanup.",
        outcomes: [
