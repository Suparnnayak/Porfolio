...
import { Search, ArrowRight, Home, Briefcase, Layers, Code2, Mail, FileText, X } from "lucide-react";
...
export default function CommandPalette() {
    ...
    const commands: Command[] = [
        ...
        { id: "resume", label: "View Resume", icon: <FileText size={16} />, action: () => router.push("/resume"), shortcut: "R" },
